...
struct Array {
  ...
  fin_force_inline constexpr Array () = default;
  fin_force_inline constexpr Array (T *_values, usize _count)
...
template <typename T>
fin_force_inline static Slice<T> slice (const Array<T> &array) {
