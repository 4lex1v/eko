...
struct List {
  ...
  fin_force_inline constexpr List () = default;
  fin_force_inline constexpr List (Memory_Arena &_arena)
    : arena { &_arena } {}

  fin_force_inline constexpr List (Memory_Arena &_arena, const List<T> &other)
  ...
  fin_force_inline constexpr Iterator begin (this const auto &self) { return Iterator(self.first); }
  fin_force_inline constexpr Iterator end   (this const auto &self) { return Iterator(nullptr); }
