...
struct Option {
  ...
  fin_force_inline constexpr Option () = default;
  fin_force_inline constexpr Option (None): has_value { false } {}
  ...
  fin_force_inline constexpr bool is_some () const { return this->has_value; }
  fin_force_inline constexpr bool is_none () const { return !this->has_value; }

  fin_force_inline constexpr operator bool () const { return is_some(); }
